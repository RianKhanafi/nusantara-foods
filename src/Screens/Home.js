...
class Menu extends Component {
  ...
  getCountdata = async () => {
    await Http.get("/countproducts").then(response => {
            ...
            <div className="col-md-1 sidebar text-center">
              <ul className="list-group list-group-flush mt-2">
                <li className="list-group-item mb-2  border-0">
                  <span className="fa fa-cutlery fa-2x text-dark"></span>
                </li>
                <li className="list-group-item  mb-2  border-0">
                  <a href="/history">
                    <span className="fa fa-history fa-2x text-dark"></span>
                  </a>
                </li>
                <li
                  ...
                  data-target="#addData"
                >
                  <span className="fa fa-plus fa-2x text-dark"></span>
                </li>
                <li className="list-group-item  mb-2  border-0">
                  <a href="#">
                    <span
                      className="fa fa-sign-out fa-2x text-dark"
            ...
            <div className="col-md-8">
              <div className="row mt-3">
                <div className="col-md-3 pt-2">
                  <input
                    type="search"
                    onKeyPress={e => this.searchvalue(e)}
                ...
                <div className="col-md-5">
                  <nav aria-label="Page navigation example">
                    <ul className="pagination justify-content-end">
                      ...
                      <div className="page-item page-link">
                        {this.state.page}
                      </div>
                      <button
                        className="page-item page-link"
